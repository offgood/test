...
class Lead2OpportunityPartner(models.TransientModel):
    ...
    def _action_convert(self):
        ...
        # self.env['customer.organize'].get_date_to_convert_name(result_opportunities.partner_name)
        # self.env['customer.organize'].get_date_to_convert_name(result_opportunities.tree)
        # self.env['customer.organize'].get_date_to_convert_name(result_opportunities.zip)
        # self.env['customer.organize'].get_date_to_convert_name(result_opportunities.country_id)
        # self.env['customer.organize'].get_date_to_convert_name(result_opportunities.state_id)
        # self.env['customer.organize'].get_date_to_convert_name(result_opportunities.email_from)
        # self.env['customer.organize'].get_date_to_convert_name(result_opportunities.phone)
        # self.env['customer.organize'].get_date_to_convert_name(result_opportunities.title)
