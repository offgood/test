...
class Lead(models.Model):
    ...
    # Address fields
    tree = fields.Many2one('res.city.zip','ที่อยู่(เลือก)', required=True,tracking=True)
    street = fields.Char('ที่อยู่',related='tree.display_name',required=True, compute='_compute_partner_address_values', readonly=False, store=True)
    street2 = fields.Char('แขวง', compute='_compute_partner_address_values', readonly=False, store=True)
    zip = fields.Char('รหัสไปรษณี',related='tree.name',required=True, tracking=True,change_default=True, compute='_compute_partner_address_values', readonly=False, store=True)
    ...
    Note_address = fields.Text('ที่อยู่เพิ่มเติม',required=True)
    # Address invoices
    ...
    Note_address_invoice = fields.Text('ที่อยู่เพิ่มเติม')
     # Address delivery
    ...
    Note_address_delivery = fields.Text('ที่อยู่เพิ่มเติม')
